...
--Date        : Wed Jan 28 13:47:17 2026
--Host        : aq-21me000tge running 64-bit Ubuntu 24.04.3 LTS
--Command     : generate_target top_led_bd.bd
--Design      : top_led_bd
...
entity top_led_bd is
  ...
  attribute CORE_GENERATION_INFO of top_led_bd : entity is "top_led_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top_led_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of top_led_bd : entity is "top_led_bd.hwdef";
end top_led_bd;

architecture STRUCTURE of top_led_bd is
  component top_led_bd_processing_system7_0_0 is
  port (
  ...
  end component top_led_bd_processing_system7_0_0;
  component top_led_bd_blink_counter_0_0 is
  port (
    clk : in STD_LOGIC;
    led : out STD_LOGIC
  );
  end component top_led_bd_blink_counter_0_0;
  component top_led_bd_shift_led_right_0_0 is
  port (
    clk : in STD_LOGIC;
    enable_shift : in STD_LOGIC;
    led_o : out STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component top_led_bd_shift_led_right_0_0;
  signal blink_counter_0_led : STD_LOGIC;
  ...
  signal shift_led_right_0_led_o : STD_LOGIC_VECTOR ( 7 downto 0 );
...
begin
  led_o(7 downto 0) <= shift_led_right_0_led_o(7 downto 0);
blink_counter_0: component top_led_bd_blink_counter_0_0
     port map (
      clk => processing_system7_0_FCLK_CLK0,
      led => blink_counter_0_led
    );
processing_system7_0: component top_led_bd_processing_system7_0_0
     port map (
...
shift_led_right_0: component top_led_bd_shift_led_right_0_0
     port map (
      clk => processing_system7_0_FCLK_CLK0,
      enable_shift => blink_counter_0_led,
      led_o(7 downto 0) => shift_led_right_0_led_o(7 downto 0)
    );
end STRUCTURE;
