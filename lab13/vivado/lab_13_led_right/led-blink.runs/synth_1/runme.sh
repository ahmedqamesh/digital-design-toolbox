...
HD_PWD='/home/aq/git/courses/digital-design-toolbox/lab13/lab_13_1/vivado/lab_13_led_right/led-blink.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_led_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_led_bd_wrapper.tcl
