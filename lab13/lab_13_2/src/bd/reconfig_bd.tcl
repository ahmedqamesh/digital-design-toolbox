...
proc create_hier_cell_icap_controller { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_clk [get_bd_pins clk] [get_bd_pins icap_sm_0/clk] [get_bd_pins interface_0/clk]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {93.750} \
   CONFIG.MMCM_CLKOUT1_DIVIDE {27} \
  ...
  # Create instance: ecc_wrapper_0, and set properties
  set block_name ecc_wrapper
  set block_cell_name ecc_wrapper_0
  if { [catch {set ecc_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ecc_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: reconfig_core_0, and set properties
  set block_name reconfig_core
  set block_cell_name reconfig_core_0
  if { [catch {set reconfig_core_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $reconfig_core_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net clk_wiz_0_clk [get_bd_pins clk_wiz_0/clk] [get_bd_pins decoupling_0/clk] [get_bd_pins icap_controller/clk] [get_bd_pins reconfig_core_0/clk] [get_bd_pins uart_interface_0/clk]
  connect_bd_net -net clk_wiz_0_clk_40 [get_bd_pins clk_wiz_0/clk_40] [get_bd_pins ila_0/clk] [get_bd_pins reconfig_core_0/clk_40]
  ...
  connect_bd_net -net reconfig_core_0_address [get_bd_pins ila_0/probe2] [get_bd_pins reconfig_core_0/address]
  connect_bd_net -net reconfig_core_0_address_elink [get_bd_pins icap_controller/address] [get_bd_pins ila_0/probe3] [get_bd_pins reconfig_core_0/address_elink]
  connect_bd_net -net reconfig_core_0_data [get_bd_pins ila_0/probe5] [get_bd_pins reconfig_core_0/data]
  connect_bd_net -net reconfig_core_0_data_received [get_bd_pins ila_0/probe7] [get_bd_pins reconfig_core_0/data_received]
  connect_bd_net -net reconfig_core_0_data_received_elink [get_bd_pins icap_controller/wready] [get_bd_pins ila_0/probe4] [get_bd_pins reconfig_core_0/data_received_elink]
  connect_bd_net -net reconfig_core_0_data_rx_elink [get_bd_pins icap_controller/wrdata] [get_bd_pins ila_0/probe6] [get_bd_pins reconfig_core_0/data_rx_elink]
  connect_bd_net -net reconfig_core_0_partial_reconfig_id [get_bd_pins ila_0/probe8] [get_bd_pins reconfig_core_0/partial_reconfig_id]
  connect_bd_net -net rstn_0_1 [get_bd_ports ext_rstn] [get_bd_pins decoupling_0/rstn] [get_bd_pins icap_controller/rstn] [get_bd_pins reconfig_core_0/rstn] [get_bd_pins uart_interface_0/rstn]
  connect_bd_net -net startupe2_primitve_0_EOS [get_bd_pins decoupling_0/enable] [get_bd_pins startupe2_primitve_0/EOS]
  connect_bd_net -net sys_clk_1 [get_bd_pins decoupling_0/clkd] [get_bd_pins partition/sys_clk]
  connect_bd_net -net uart_interface_0_data_rx [get_bd_pins ila_0/probe1] [get_bd_pins reconfig_core_0/data_rx] [get_bd_pins uart_interface_0/data_rx]
  connect_bd_net -net uart_interface_0_new_data_rx [get_bd_pins ila_0/probe0] [get_bd_pins reconfig_core_0/new_data_rx] [get_bd_pins uart_interface_0/new_data_rx]
