...
--Command     : generate_target multiplier_16bit_mults.bd
--Design      : multiplier_16bit_mults
...
entity multiplier_16bit_mults is
  port (
  ...
  attribute CORE_GENERATION_INFO of multiplier_16bit_mults : entity is "multiplier_16bit_mults,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=multiplier_16bit_mults,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of multiplier_16bit_mults : entity is "multiplier_16bit_mults.hwdef";
end multiplier_16bit_mults;

architecture STRUCTURE of multiplier_16bit_mults is
  component multiplier_16bit_mults_mult_gen_0_0 is
  port (
    CLK : in STD_LOGIC;
  ...
  end component multiplier_16bit_mults_mult_gen_0_0;
  ...
  attribute X_INTERFACE_PARAMETER of CLK_0 : signal is "XIL_INTERFACENAME CLK.CLK_0, CLK_DOMAIN multiplier_16bit_mults_CLK_0, FREQ_HZ 10000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
mult_gen_0: component multiplier_16bit_mults_mult_gen_0_0
     port map (
